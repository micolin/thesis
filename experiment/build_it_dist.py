...
def build_ITDistribution(item_tag_file):
	'''
...
def build_item_tag_distribution(item_tag_file):
	build_ITDistribution(item_tag_file)
...
if __name__=="__main__":
	args = sys.argv
	item_tag_file = args[1]
	build_item_tag_distribution(item_tag_file)
