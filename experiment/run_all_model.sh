...
do 
	...
	do
		...
		do
			...
			python ubase_hybirdModel.py $set_level $TRAIN_PROB 'tag' $recommend_job $user_k 500 > ${RESULT_ROOT_DIR}/ubhybird_tag_${recommend_job}_${set_level}_${TRAIN_PROB}_${user_k}

			python ubase_hybirdModel.py $set_level $TRAIN_PROB 'lda' $recommend_job $user_k 500 $TOPIC_NUM > ${RESULT_ROOT_DIR}/ubhybird_lda_${recommend_job}_${set_level}_${TRAIN_PROB}_${TOPIC_NUM}_${user_k}
		done
	done
done
